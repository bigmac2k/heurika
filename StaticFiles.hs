...
staticFiles = $(do
    ...
    let initialPaths = ["Makefile","CmdArgs.hs","Core.hs","Error.hs","Graph.hs","HeuRika.hs","History.hs","LinkedClients.hs","Messages.hs","Parser.hs","PdfGraph.hs","Renderer.hs","StaticFiles.hs","Types.hs","Plugins/GtkViewer.hs","Plugins/Web.hs","Plugins/Web"]
        checkReadFile fn = runIO $ BS.readFile fn
    -- I shall hate myself for this...
    let allFiles fns | null fns = return []
                     | otherwise = do
